...
### **2. Детализация количества запросов ([Queries Counts Detailed](queries-counts-detailed))**
...
### **3. Детализация текста запросов ([Queries Text Detailed](queries-text-detailed))**
