...
3. Верстаем и поднимаем в докере дашборд о поисковых запросах Яндекса. Детектим аномалии и тренды во временном ряде с помощью fb Prophet. (PostgreSQL/Vizro/Plotly/Prophet/Dash/Docker) [здесь..](/Practical%20tasks/yandex_dashboard)
## SQL
